...
public enum ActivatorType {
    ...
    */
    ...
    private final RaFunction<Parameters> creator;
    ...
    ActivatorType(String alias, RaFunction<Parameters> creator, RaFunction<ConfigurationSection> loader, boolean locatable) {
        this(alias, creator, loader, locatable, false);
    }

    ActivatorType(String alias, RaFunction<Parameters> creator, RaFunction<ConfigurationSection> loader) {
