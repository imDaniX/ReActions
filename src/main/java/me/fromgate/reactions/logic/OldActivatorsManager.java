...
@Deprecated
public class OldActivatorsManager {

    private Map<OldActivatorType, Set<Activator>> typeActivators;
    // Names in lower case
    private Map<String, Activator> activators;
    private Set<String> stopexec;
    
    public OldActivatorsManager() {
        typeActivators = new EnumMap<>(OldActivatorType.class);
        for (OldActivatorType type : OldActivatorType.values())
    ...
    private void loadGroup(String group, boolean clear) {
        ...
        for (String sType : cfg.getKeys(false)) {
            OldActivatorType type = OldActivatorType.getByName(sType);
     ...
     */
    private Activator loadActivator(OldActivatorType type, String name, String group, YamlConfiguration cfg) {
    ...
    private void clearGroup(String name) {
        for (OldActivatorType type : typeActivators.keySet()) {
     ...
     */
    public Set<Activator> getActivators(OldActivatorType type) {
