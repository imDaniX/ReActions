...
public class MessageStorage extends Storage {
    ...
    private final MessageTrigger activator;


    public MessageStorage(Player player, MessageTrigger activator, String message) {
        super(player, ActivatorType.MESSAGE);
        this.activator = activator;
        this.message = message;
    }

    public boolean isForActivator(MessageTrigger messageActivator) {
