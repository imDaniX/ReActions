...
public class MessageTrigger extends Trigger {
    ...
    private MessageTrigger(ActivatorBase base, CheckType type, Source source, String mask) {
        super(base);
        this.type = type;
        this.source = source;
        this.mask = mask;
    ...
    public static MessageTrigger create(ActivatorBase base, Parameters param) {
        ...
        return new MessageTrigger(base, type, source, mask);
    }

    public static MessageTrigger load(ActivatorBase base, ConfigurationSection cfg) {
