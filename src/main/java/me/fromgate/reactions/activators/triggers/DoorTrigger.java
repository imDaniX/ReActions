...
public class DoorTrigger extends Trigger implements Locatable {
    ...
    private DoorTrigger(ActivatorBase base, String state, String world, int x, int y, int z) {
        super(base);
        this.state = state;
        this.world = world;
        this.x = x;
    ...
    public static DoorTrigger create(ActivatorBase base, Parameters p) {
        ...
        if (targetBlock == null || BlockUtils.isOpenable(targetBlock)) {
            ...
            return new DoorTrigger(base, state, world, x, y, z);
        } else return null;
    }

    public static DoorTrigger load(ActivatorBase base, ConfigurationSection cfg) {
