...
public class PlateTrigger extends Trigger implements Locatable {
    ...
    private PlateTrigger(ActivatorBase base, String world, int x, int y, int z) {
        super(base);
        this.world = world;
        this.x = x;
        this.y = y;
    ...
    public static PlateTrigger create(ActivatorBase base, Parameters p) {
        ...
        if (targetBlock != null && BlockUtils.isPlate(targetBlock)) {
            ...
            return new PlateTrigger(base, world, x, y, z);
        }
        return null;
    }

    public static PlateTrigger load(ActivatorBase base, ConfigurationSection cfg) {
