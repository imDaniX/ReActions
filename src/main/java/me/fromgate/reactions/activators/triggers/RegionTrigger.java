...
@Getter
public class RegionTrigger extends Trigger implements Locatable {

    private final String region;

    private RegionTrigger(ActivatorBase base, String region) {
        super(base);
        this.region = region;
    }

    public static RegionTrigger create(ActivatorBase base, Parameters param) {
        String region = param.getString("region", param.toString());
        RaWorldGuard.updateRegionCache();
        return new RegionTrigger(base, region);
    }

    public static RegionTrigger load(ActivatorBase base, ConfigurationSection cfg) {
