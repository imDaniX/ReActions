...
public class LeverTrigger extends Trigger implements Locatable {
    // TODO: Use enum
    ...
    private LeverTrigger(ActivatorBase base, String state, String world, int x, int y, int z) {
        super(base);
        this.state = state;
        this.world = world;
        this.x = x;
    ...
    public static LeverTrigger create(ActivatorBase base, Parameters p) {
        ...
        if (targetBlock != null && targetBlock.getType() == Material.LEVER) {
            ...
            return new LeverTrigger(base, state, world, x, y, z);
        } else return null;
    }

    public static LeverTrigger load(ActivatorBase base, ConfigurationSection cfg) {
