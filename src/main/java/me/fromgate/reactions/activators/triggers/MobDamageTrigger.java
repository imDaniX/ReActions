...
public class MobDamageTrigger extends Trigger {
    private final String mobName;
    // TODO: EntityType
    private final String mobType;
    private final String itemStr;

    private MobDamageTrigger(ActivatorBase base, String type, String name, String item) {
        super(base);
        this.mobType = type;
        this.mobName = name;
        this.itemStr = item;
    ...
    public static MobDamageTrigger create(ActivatorBase base, Parameters param) {
        ...
        return new MobDamageTrigger(base, type, name, itemStr);
    }

    public static MobDamageTrigger load(ActivatorBase base, ConfigurationSection cfg) {
