...
@Getter
public class ItemHoldTrigger extends Trigger /*implements Manageable*/ {
    // TODO: Store VirtualItem
    private final String itemStr;
    // TODO: Hand option

    private ItemHoldTrigger(ActivatorBase base, String item) {
        super(base);
        this.itemStr = item;
    }

    public static ItemHoldTrigger create(ActivatorBase base, Parameters param) {
        String item = param.getString("item", "");
        return new ItemHoldTrigger(base, item);
    }

    public static ItemHoldTrigger load(ActivatorBase base, ConfigurationSection cfg) {
