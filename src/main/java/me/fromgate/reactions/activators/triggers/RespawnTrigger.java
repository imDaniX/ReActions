...
public class RespawnTrigger extends Trigger {

    private final DeathCause deathCause;

    private RespawnTrigger(ActivatorBase base, DeathCause cause) {
        super(base);
        this.deathCause = cause;
    }

    public static RespawnTrigger create(ActivatorBase base, Parameters param) {
        DeathCause cause = DeathCause.getByName(param.getString("cause", param.toString()));
        return new RespawnTrigger(base, cause);
    }

    public static RespawnTrigger load(ActivatorBase base, ConfigurationSection cfg) {
