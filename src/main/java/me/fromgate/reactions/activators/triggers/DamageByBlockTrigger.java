...
public class DamageByBlockTrigger extends Trigger implements Locatable {

    private final String blockStr;
    private final String blockLocation;
    private final String damageCause;

    private DamageByBlockTrigger(ActivatorBase base, String block, String location, String cause) {
        super(base);
        this.blockStr = block;
    ...
    public static DamageByBlockTrigger create(ActivatorBase base, Parameters param) {
        String block = param.getString("block", "");
        String location = param.getString("loc", "");
        String cause = param.getString("cause", "ANY");
        return new DamageByBlockTrigger(base, block, location, cause);
    }

    public static DamageByBlockTrigger load(ActivatorBase base, ConfigurationSection cfg) {
