...
@Getter
public class RegionEnterTrigger extends Trigger implements Locatable {

    private final String region;

    private RegionEnterTrigger(ActivatorBase base, String region) {
        super(base);
        this.region = region;
    }

    public static RegionEnterTrigger create(ActivatorBase base, Parameters param) {
        String region = param.getString("region", param.toString());
        RaWorldGuard.updateRegionCache();
        return new RegionEnterTrigger(base, region);
    }

    public static RegionEnterTrigger load(ActivatorBase base, ConfigurationSection cfg) {
