...
public class CommandTrigger extends Trigger {
    ...
    private CommandTrigger(ActivatorBase base, String command, boolean starts, boolean useRegex, boolean consoleAllowed) {
        super(base);
    ...
    public static CommandTrigger create(ActivatorBase base, Parameters param) {
        ...
        return new CommandTrigger(base, command, starts, useRegex, consoleAllowed);
    }

    public static CommandTrigger load(ActivatorBase base, ConfigurationSection cfg) {
