...
public class InventoryClickTrigger extends Trigger {
    ...
    private InventoryClickTrigger(ActivatorBase base, String inventoryName, ClickType click, InventoryAction action,
    ...
    public static InventoryClickTrigger create(ActivatorBase base, Parameters param) {
        ...
        return new InventoryClickTrigger(base, inventoryName, click, action, inventory, slotType, numberKey, slotStr, itemStr);
    }

    public static InventoryClickTrigger load(ActivatorBase base, ConfigurationSection cfg) {
