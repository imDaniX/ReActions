...
public class BlockClickTrigger extends Trigger implements Locatable {
    private final Material blockType;
    private final String blockLocation;
    private final ClickType click;

    private BlockClickTrigger(ActivatorBase base, Material block, String location, ClickType click) {
        super(base);
    ...
    public static BlockClickTrigger create(ActivatorBase base, Parameters param) {
        ...
        return new BlockClickTrigger(base, block, loc, click);
    }

    public static BlockClickTrigger load(ActivatorBase base, ConfigurationSection cfg) {
