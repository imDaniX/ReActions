...
public class ButtonTrigger extends Trigger implements Locatable {
    private final String world;
    private final int x;
    private final int y;
    private final int z;

    private ButtonTrigger(ActivatorBase base, String world, int x, int y, int z) {
        super(base);
        this.world = world;
        this.x = x;
        this.y = y;
    ...
    public static ButtonTrigger create(ActivatorBase base, Parameters p) {
        ...
        return new ButtonTrigger(base, loc.getWorld().getName(), loc.getBlockX(), loc.getBlockY(), loc.getBlockZ());
    }

    public static ButtonTrigger load(ActivatorBase base, ConfigurationSection cfg) {
        ...
        return new ButtonTrigger(base, world, x, y, z);
    }
