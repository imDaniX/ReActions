...
public class DamageByMobTrigger extends Trigger {
    ...
    private DamageByMobTrigger(ActivatorBase base, String damagerName, String damagerType, String entityType, String damageCause) {
        super(base);
    ...
    public static DamageByMobTrigger create(ActivatorBase base, Parameters param) {
        ...
        return new DamageByMobTrigger(base, damagerType, damagerName, entityType, damageCause);
    }

    public static DamageByMobTrigger load(ActivatorBase base, ConfigurationSection cfg) {
        ...
        return new DamageByMobTrigger(base, damagerType, damagerName, entityType, cause);
    }
