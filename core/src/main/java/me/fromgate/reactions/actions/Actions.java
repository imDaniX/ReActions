...
public enum Actions {
	...
	*/
	...
	TOWN_SET("townset", new ActionTownSet(), true),
	TOWN_KICK("townkick", new ActionTownKick(), true),
	// TODO: Don't like it
	...
	EFFECT("effect", new ActionEffect()),
	...
	RNC_SET_RACE("setrace", new ActionRacesAndClasses(true), true),
	RNC_SET_CLASS("setclass", new ActionRacesAndClasses(false), true),
	...
	FCT_POWER_ADD("factaddpower", new ActionFactionsPowerAdd()),
