...
public class CmdCopy extends Cmd {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (copyMode.equalsIgnoreCase("all")) {
            if (Activators.copyAll(id1, id2)) Msg.printMSG(sender, "msg_copyall", id1, id2);
            else Msg.printMSG(sender, "msg_copyallfailed", 'c', '4', id1, id2);
        } else if (copyMode.equalsIgnoreCase("f") || copyMode.equalsIgnoreCase("flag")) {
            if (Activators.copyFlags(id1, id2)) Msg.printMSG(sender, "msg_copyflags", id1, id2);
            ...
            if (Activators.copyActions(id1, id2)) Msg.printMSG(sender, "msg_copyactions", id1, id2);
            ...
            if (Activators.copyReactions(id1, id2)) Msg.printMSG(sender, "msg_copyreactions", id1, id2);
